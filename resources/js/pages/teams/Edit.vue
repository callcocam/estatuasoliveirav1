...
<template>
    ...
    <div class="flex flex-col space-y-10">
        ...
        <div v-if="permissions.canUpdateTeam" class="space-y-6">
            <Heading
                variant="small"
                :title="t('app.teams.edit.settings.title')"
                :description="t('app.teams.edit.settings.description')"
            />
            ...
            >
                <div class="grid gap-2">
                    <Label for="name">{{
                        t('app.teams.edit.settings.name_label')
                    }}</Label>
                    <Input
                        id="name"
                        name="name"
        ...
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <Heading
                    variant="small"
                    :title="t('app.teams.members.title')"
                    :description="
                        permissions.canCreateInvitation
                            ? t('app.teams.members.description')
                            : ''
                    "
                />
        ...
        <div v-if="invitations.length > 0" class="space-y-6">
            <Heading
                variant="small"
                :title="t('app.teams.invitations.title')"
                :description="t('app.teams.invitations.description')"
            />
                ...
                >
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-muted-foreground">
                                {{ t(`app.teams.roles.${invitation.role}`) }}
                            </div>
                        </div>
                    </div>
        ...
        >
            <Heading
                variant="small"
                :title="t('app.teams.edit.danger.title')"
                :description="t('app.teams.edit.danger.description')"
            />
            <div
            ...
            >
                ...
                >
                    <p class="font-medium">
                        {{ t('app.teams.edit.danger.warning') }}
                    </p>
                    <p class="text-sm">
                        {{ t('app.teams.edit.danger.caution') }}
                    </p>
                </div>
                <Button
                    ...
                    >{{ t('app.teams.edit.danger.delete_button') }}</Button
                >
            </div>
        </div>
    </div>
