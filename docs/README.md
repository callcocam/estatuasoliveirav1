...
| 1 | [01-banco-de-dados.md](01-banco-de-dados.md) | — | Migrations ULID, models, factories, seeders |
| 2 | [02-migracao-de-dados.md](02-migracao-de-dados.md) | 1 | Comando de importação do dump legado (UUID → ULID) |
| 3 | [03-design-system.md](03-design-system.md) | — | Dois temas (Serene Stone / Terracotta Earth) com troca em runtime |
| 4 | [04-site-publico.md](04-site-publico.md) | 1, 3 | Páginas públicas (Home, História, Galeria, Contato, Termos) |
| 5 | [05-admin.md](05-admin.md) | 1, 3 | Painel administrativo completo |
| 6 | [06-midias-e-arquivos.md](06-midias-e-arquivos.md) | 1, 2 | Migração física das imagens do projeto antigo |
| 7 | [07-qualidade-e-deploy.md](07-qualidade-e-deploy.md) | todos | Cobertura de testes, revisão, preparação de deploy |
