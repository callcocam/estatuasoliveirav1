...
| `GHCR_REPO` | `callcocam/estatuasoliveira` | `vps-build-push` (push da imagem) |
...
```bash
REPO="callcocam/estatuasoliveira"
VPS_HOST="<ip-do-vps>"
VPS_USER="root"
...
gh secret set SSH_PRIVATE_KEY --repo "${REPO}" --env production < ~/.ssh/id_ed25519_estatuasoliveira_deploy
